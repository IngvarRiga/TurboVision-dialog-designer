...
- [ ] использование JSON для сохранения разрабатываемых окон

#### Известные проблемы
---
- При использовании национальных языков при вводе данных в TInputLIne возникают ошибки при использовании клавиши Shift. Тут к сожалению - не мои ошибки, а разработчика библиотеки (я его поставил в известность, обещался поправить, когда- не знаю);
