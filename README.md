...
---
###### 05.04.2022
- [x] Добавлена функция автоматического подбора размера диалога (в основном меню программы). Функция смотрит левую и нижнюю границы компонентов в окне и выравнивает размеры диалогового окна;
