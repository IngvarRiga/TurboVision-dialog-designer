...
При сохранении в JSON используется [![JSON for Modern C++](https://raw.githubusercontent.com/nlohmann/json/master/doc/json.gif)](https://github.com/nlohmann/json/releases)
...
#### А теперь немного о самом проекте:
 ...
 - библиотеку nlohmann::json ищите по ссылке вверху;
...
---
###### 01.04.2022
- [x] Сделан первый вариант сохранения в JSON,(сохраняются только: TDialog, TInputLine, TButton, TStaticText, TCheckBoxes, TRadioButtons, остальное пока нет :) );
